...
import com.rickhuisman.musicapp.utils.RecyclerViewSongsAdapter;
import com.rickhuisman.musicapp.utils.SpotifyService;
import com.rickhuisman.musicapp.utils.SpotifyServiceCallback;
import com.rickhuisman.musicapp.utils.ACRCloudRecognizer;
...
//                    callback.getStepperLayout().setNextButtonColor(getResources().getColor(R.color.colorPrimary));
    ...
    public void setUpDialog(final Spotify spotify) {
        if (Objects.equals(acrcloudServiceSuccess, "Success")) {
            ...
            View root = getLayoutInflater().inflate(R.layout.dialog_song_find_result, null);
