...
import com.rickhuisman.musicapp.ui.activities.MainActivity;
    ...
    public void uploadSong() {
        ...
        uploadTask.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                PublicSongsMap.put("TrackUrl", taskSnapshot.getDownloadUrl().toString());
                realtimeDB.getReference("Music").child("Public Songs").child("Songs").child(PublicSongsMap.get("TrackId").toString())
                        .setValue(PublicSongsMap)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                realtimeDB.getReference("Music").child("Users").child(user).child("Songs").child(PublicSongsMap.get("TrackId").toString())
                                        .setValue(PublicSongsMap.get("TrackId").toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
